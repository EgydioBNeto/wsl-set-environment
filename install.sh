...
prerequisitesBrew=("docker" "docker-compose" "kubernetes-cli" "kubectx" "terraform" "ansible" "oci-cli" "gh" "pulumi" "curlie" "asdf" "tldr" "git-flow" "micro" "pre-commit" "terraform-docs" "k9s" "bat" "dog" "openvpn" "exa" "pipx" "tmux" "hr" "emojify" "coreutils" "xo/xo/usql" "helm" "vault-cli")
